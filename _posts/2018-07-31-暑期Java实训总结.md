...
![image](https://github.com/1605047284/2018.7-JavaWeb/raw/master/images/singleton.PNG)
...
![image](https://github.com/1605047284/2018.7-JavaWeb/raw/master/images/mvc在javaweb体现.png)
...
![image](https://github.com/1605047284/2018.7-JavaWeb/raw/master/images/不分层.png)

不分层时，对于每一个特定的功能，比如登入、注册，都需要写一个特定的函数，在每个函数中，会出现相同的数据库操作，造成冗余。所以采用分层思想。

![image](https://github.com/1605047284/2018.7-JavaWeb/raw/master/images/分层.png)
...
![image](https://github.com/1605047284/2018.7-JavaWeb/raw/master/images/Ajax.PNG)

### 文件上传

主要用于用户头像的上传，在主页面，用户点击上传头像后，该用户的Id会传到addImage.jsp页面中，然后这个jsp会调用MyUploadServlet的upImage方法处理。

![image](https://github.com/1605047284/2018.7-JavaWeb/raw/master/images/上传文件表单.PNG)
